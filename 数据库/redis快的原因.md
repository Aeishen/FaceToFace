...
![](D:\UserProfiles\aeishenlin\Desktop\简答题\数据库\图片\redis快的原因\导图.png)
...
![](D:\UserProfiles\aeishenlin\Desktop\简答题\数据库\图片\redis快的原因\redis数据结构.png)
...
![](D:\UserProfiles\aeishenlin\Desktop\简答题\数据库\图片\redis快的原因\c语言中字符串的展示.png)

这个图是字符串在 C 语言中的存储方式，想要获取 「Redis」的长度，需要从头开始遍历，直到遇到 '\0' 为止。

![](D:\UserProfiles\aeishenlin\Desktop\简答题\数据库\图片\redis快的原因\resid字符串.png)
...
![](D:\UserProfiles\aeishenlin\Desktop\简答题\数据库\图片\redis快的原因\双端链表.png)

##### 1.前后节点

链表里每个节点都带有两个指针，prev 指向前节点，next 指向后节点。这样在时间复杂度为 O(1) 内就能获取到前后节点。

![](D:\UserProfiles\aeishenlin\Desktop\简答题\数据库\图片\redis快的原因\双端链表前后节点.png)

##### 2.头尾节点

![](D:\UserProfiles\aeishenlin\Desktop\简答题\数据库\图片\redis快的原因\双端链表头尾节点.png)
...
![](D:\UserProfiles\aeishenlin\Desktop\简答题\数据库\图片\redis快的原因\压缩列表.png)
...
![](D:\UserProfiles\aeishenlin\Desktop\简答题\数据库\图片\redis快的原因\跳跃表.png)
...
![](D:\UserProfiles\aeishenlin\Desktop\简答题\数据库\图片\redis快的原因\跳跃表真实存储结构.png)
...
![](D:\UserProfiles\aeishenlin\Desktop\简答题\数据库\图片\redis快的原因\redis线程模型.png)
...
![](D:\UserProfiles\aeishenlin\Desktop\简答题\数据库\图片\redis快的原因\redis请求.png)
...
#### ![](D:\UserProfiles\aeishenlin\Desktop\简答题\数据库\图片\redis快的原因\redis单线程处理流程.png)
