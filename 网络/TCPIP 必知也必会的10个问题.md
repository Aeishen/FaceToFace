...
![](图片/TCPIP 必知也必会的10个问题/模型对照.jpg)

TCP/IP协议族按照层次由上到下，层层包装。最上面的是应用层，这里面有http，ftp 等等我们熟悉的协议。而第二层则是传输层，著名的TCP和UDP协议就在这个层次。第三层是网络层，IP协议就在这里，它负责对数据加上IP地址和其他的数据以确定传输的目标。第四层是数据链路层，这个层次为待传送的数据加入一个以太网协议头，并进行CRC编码，为最后的数据传输做准备。

![](图片/TCPIP 必知也必会的10个问题/数据进入协议栈时的服装guoc.jpg)

上图清楚地表示了TCP/IP协议中每个层的作用，而TCP/IP协议通信的过程其实就对应着数据入栈与出栈的过程。入栈的过程，数据发送方每层不断地封装首部与尾部，添加一些传输的信息，确保能传输到目的地。出栈的过程，数据接收方每层不断地拆除首部与尾部，得到最终传输的数据。

![](图片/TCPIP 必知也必会的10个问题/http协议数据封装解封装过程.jpg)
...
![](图片/TCPIP 必知也必会的10个问题/数据链路层协议.jpg)
...
![](图片/TCPIP 必知也必会的10个问题/IP协议头.jpg)
...
![](图片/TCPIP 必知也必会的10个问题/TCPUDP对比.jpg)
...
![](图片/TCPIP 必知也必会的10个问题/TCP和UDP协议的一些应用.jpg)
...
![](图片/TCPIP 必知也必会的10个问题/TCP三次握手.jpg)
...
![](图片/TCPIP 必知也必会的10个问题/TCP四次挥手.jpg)
...
![](图片/TCPIP 必知也必会的10个问题/TCP数据传输例子.jpg)
...
![](图片/TCPIP 必知也必会的10个问题/TCP拥塞控制例子.jpg)
...
![](图片/TCPIP 必知也必会的10个问题/TCP拥塞控制例子2.jpg)
...
![](图片/TCPIP 必知也必会的10个问题/TCP拥塞控制过程.jpg)
...
![](图片/TCPIP 必知也必会的10个问题/TCP快重传例子.jpg)
